			...
			<Container spacing={['verticalXXXLrg']}>
				...
				<section className={about.content}>
					<div className={about.image}>
						<img src="/img/profile_03.png" alt="Risa's profile photo" style={{height:600, marginTop:100}} />
					...
					<div className={about.copy} >
						<CopyBlock
							...
							copy2="• Awardee of Beasiswa Unggulan Kemendikbudristek"
							copy3="• 3rd Winner of The Most Outstanding Student (Faculty of Engineering)"
							copy4="• Partial-Funded Awardee of Asian Youth Exchange Program Chapter Turkey"
							copy5="• Awardee of Research Funding Program Kreativitas Mahasiswa (PKM)"
