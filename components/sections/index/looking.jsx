	...
	return (
		<Section classProp={`${looking.section} borderBottom`}>	
			<Container classProp={`${section.title} ${looking.container}`} spacing={['verticalXXXLrg']}>
				...
				<h2 className={looking.json}>Position : &#123;</h2>
				<h2 className={looking.jsonSub}><span className={looking.highlight}>Mobile App Developer</span>,</h2>
				<h2 className={looking.jsonSub}><span className={looking.highlight2}>Web Developer</span>,</h2>
				<h2 className={looking.jsonSub}><span className={looking.highlight2}>Project Manager</span></h2>
